...
public class CasManagementLdapAuthorizationConfiguration {
    ...
    public AuthorizationGenerator authorizationGenerator() {
        final LdapAuthorizationProperties ldapAuthz = casProperties.getLdap().getLdapAuthz();
        final ConnectionFactory connectionFactory = LdapUtils.newLdaptivePooledConnectionFactory(casProperties.getLdap());
