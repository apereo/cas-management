...
/**
 * Data class for SamlRegisteredService.
 */
export class SamlRegisteredService extends RegexRegisteredService {
  ...
  issuerSigningKeyLocation: string;
  ...
  /**
   * Returns true if the passed object is an instance of SamlRegisteredService.
   *
  ...
  constructor(service?: RegisteredService) {
    ...
    this.issuerSigningKeyLocation = s?.issuerSigningKeyLocation;
    this.issuerSigningAlgorithm = s?.issuerSigningAlgorithm;
